...
def test_elaborate_caculation():
    ...
    asphalt_layer = AsphaltLayerSpecification(0.9, 64.0, 0.146, 5712.0)
    asphalt_layer.stiffness_ratio_nu = 0.35
    asphalt_layer.fatigue_asphalt_alpha = 0.5
    asphalt_layer.fatigue_asphalt_beta = 5.4
    nordic_stone_layer = NordicStoneLayerSpecification(0.28, 2.45)
    ...
    grass_wave_runup_layer = GrassWaveRunupLayerSpecification(
        0.3, TopLayerType.GrassClosedSod
    )
...
def get_grass_wave_impact_calculation_settings() -> GrassWaveImpactCalculationSettings:
    top_layer_closed_sod = GrassWaveImpactTopLayerSettings(TopLayerType.GrassClosedSod)
    ...
    top_layer_open_sod = GrassWaveImpactTopLayerSettings(TopLayerType.GrassOpenSod)
